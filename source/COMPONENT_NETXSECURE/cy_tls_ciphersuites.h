...
static NX_SECURE_TLS_CIPHERSUITE_INFO cy_tls_ciphersuite_lookup_table[] =
{
...
const NX_SECURE_TLS_CRYPTO cy_tls_ciphers =
{
    /* Ciphersuite lookup table and size. */
    cy_tls_ciphersuite_lookup_table,
    sizeof(cy_tls_ciphersuite_lookup_table) / sizeof(NX_SECURE_TLS_CIPHERSUITE_INFO),
